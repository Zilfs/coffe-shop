    ...
    <div class="container-fluid px-5">
        ...
        <div class="row">
                                    ...
                                    <div class="d-flex w-100">
                                        <div class="w-50">
                                            <a href="{{ route('manager-edit-user', $item->id) }}"
                                                class="btn btn-warning w-100"><i class="fa-solid fa-pen-to-square"></i></a>
                                        </div>
                                        <div class="mx-2"></div>
                                        <form action="{{ route('manager-delete-user', $item->id) }}" method="POST"
                                            class="w-50">
                                            @csrf
                                            @method('DELETE')
            ...
            <div class="card card-shadow w-100 px-4 py-4 mt-5">
                <a href="{{ route('manager-add-user') }}" class="btn btn-primary w-100">+ Add New Data</a>
            </div>
        </div>
    </div>
@endsection
