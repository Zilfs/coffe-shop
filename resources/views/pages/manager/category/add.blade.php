...
@section('page-contents')
    <div class="container-fluid px-5">
        ...
        <div class="row">
            <form action="{{ route('manager-save-category') }}" class="w-100" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card card-shadow w-100 px-4 py-4 mt-5">
                    ...
                    <a href="{{ route('manager-data-categories') }}" class="btn btn-warning w-100">Cancel</a>
                </div>
            </form>
        </div>
    </div>
